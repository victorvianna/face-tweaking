...
// triangularization
void AddSmile::calculateTriangles(vector<Triangle> & triangles)
{
...
void AddSmile::morphTriangle(Mat &img1, Mat &img2, Mat &img, vector<Point2f> &t1, vector<Point2f> &t2, vector<Point2f> &t, double alpha)
{
...
void AddSmile::applyAffineTransform(Mat &warpImage, Mat &src, vector<Point2f> &srcTri, vector<Point2f> &dstTri)
{
